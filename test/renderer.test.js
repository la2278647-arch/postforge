...
test('v0.3.0 新主题注册完整且字段齐全', () => {
  ...
  for (const id of ['nord', 'coffee', 'midnight', 'one-dark', 'solarized', 'github-light', 'solarized-dark', 'mint']) {
    const t = THEMES[id];
...
test('六个主题均可渲染且配色互不相同', () => {
  const md = ':::tip t\nx\n:::\n\n| A |\n|---|\n| 1 |\n\n```js\nconst a = 1;\n```';
  const outputs = ['clean', 'paper', 'dark', 'nord', 'coffee', 'midnight', 'one-dark', 'solarized', 'github-light', 'solarized-dark', 'mint'].map((id) => ({
    id,
